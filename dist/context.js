    ...
    try {
        ...
        if (existingMatch >= 0) {
            ...
            if (options.decisions !== undefined)
                session.decisions = options.decisions;
            if (options.openTasks !== undefined)
                session.openTasks = options.openTasks;
            if (options.knownIssues !== undefined)
                session.knownIssues = options.knownIssues;
